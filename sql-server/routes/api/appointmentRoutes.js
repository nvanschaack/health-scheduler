...
const {bookAppt, seeAllApptsByProvider, seeOneApptProvider, seeAllApptsByPatient, seeOneApptPatient, seeDayOfAppts} = require('../../controllers/appointmentControllers');
